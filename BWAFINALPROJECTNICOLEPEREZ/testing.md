...
### How It Differs from Class Code
...
| Screen | Description |
|--------|-------------|
| **Feed** | ain home screen — nearby trade listings with images, user info, and what they're looking for |
...
All screens share a dynamically built bottom nav bar, injected into each screen's `.bottom-nav` div by `buildNavs()` in `testing.js`.
